...
public class KafkaConfig {
    ...
    /**
     * Consumer Factory cho Kafka Consumer (để nhận Debezium CDC events).
     */
    @Bean
    public ConsumerFactory<String, Object> consumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "post-cache-invalidation-group");
    ...
    /**
     * Kafka Listener Container Factory cho @KafkaListener.
     */
    @Bean
